    ...
    <div className="min-h-screen grid place-items-center p-6 bg-gray-100">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-gray-300 bg-white p-8 shadow-xl">
        ...
        <div className="space-y-3">
          ...
          <input
            className="h-10 w-full rounded-md border border-gray-300 px-3 placeholder:text-gray-400 text-black"
            value={name}
        ...
        <div className="space-y-3">
          ...
          <select
            className="h-10 w-full rounded-md border border-gray-300 px-3 text-black"
            value={role}
